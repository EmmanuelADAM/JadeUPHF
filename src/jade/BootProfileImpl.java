...
public class BootProfileImpl extends ProfileImpl {
    ...
    public void setArgProperties(ExtendedProperties source) {
        ...
        if (value != null) {
            try {
                Vector<Object> v = Specifier.parseSpecifierList(value);
                // Convert the Vector into a List
                List<Specifier> l = new ArrayList<>(v.size());
                Enumeration<Object> e = v.elements();
                while (e.hasMoreElements()) {
                    l.add((Specifier) e.nextElement());
                }
        ...
        if (value != null) {
            ...
            for (Enumeration<Specifier> e = helper.getCommandLineAgentSpecifiers(agentVector);
                 e.hasMoreElements(); ) {
        ...
        // Note All the java.util.ArrayList structures will only print their type unless a
