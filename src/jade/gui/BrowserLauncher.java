...
public class BrowserLauncher {
    ...
    private static boolean loadClasses() {
        switch (jvm) {
            case MRJ_2_0:
                ...
                } catch (ClassNotFoundException | IllegalAccessException | NoSuchFieldException | NoSuchMethodException cnfe) {
            ...
            case MRJ_2_1:
                ...
                } catch (ClassNotFoundException | IllegalAccessException | SecurityException | NoSuchMethodException | NoSuchFieldException cnfe) {
                    errorMessage = cnfe.getMessage();
                    return false;
                }
                break;
        ...
        switch (jvm) {
            case MRJ_2_0:
                try {
                    ...
                    // me know.
                    return appleEventConstructor.newInstance(gurlType, gurlType, aeTarget, kAutoGenerateReturnID, kAnyTransactionID);
                } catch (IllegalAccessException | InvocationTargetException | InstantiationException iae) {
                    browser = null;
            ...
            case MRJ_2_1:
                ...
                } catch (IllegalArgumentException | IllegalAccessException iare) {
                    browser = null;
    ...
    public static void openURL(String url) throws IOException {
        ...
        switch (jvm) {
            ...
            case WINDOWS_NT, WINDOWS_9x -> Runtime.getRuntime().exec(new String[]{(String) browser, FIRST_WINDOWS_PARAMETER,
