...
public class VisualStringList extends JPanel {
	...
	public VisualStringList(java.util.Iterator content,Component ownerGui)
	{
		owner = ownerGui;
		listModel = new DefaultListModel<?>();
     ...
     */
    public Enumeration<Object> getContent() {
    ...
    private class VisualListCellRenderer extends DefaultListCellRenderer {
        private final VisualStringList myList;
