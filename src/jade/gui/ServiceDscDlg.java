...
public class ServiceDscDlg extends JDialog {
    ...
    ServiceDescription viewSD(ServiceDescription dsc, boolean ed, boolean checkMandatorySlots) {
        ...
        Iterator<Property> temp = serviceDesc.getAllProperties();
        //#DOTNET_EXCLUDE_END
		/*#DOTNET_INCLUDE_BEGIN
        ...
        bOK.addActionListener(e -> {
            ...
            if (param.equals("OK")) {
                if (editable) {
                    ...
                    Enumeration<Object> lang = languagesListPanel.getContent();
                    while (lang.hasMoreElements())
                        out.addLanguages((String) lang.nextElement());

                    Enumeration<Object> onto = ontologiesListPanel.getContent();
                    while (onto.hasMoreElements())
                        out.addOntologies((String) onto.nextElement());

                    //Protocols
                    Enumeration<Object> proto = protocolsListPanel.getContent();
