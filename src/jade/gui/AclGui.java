            ...
            //#DOTNET_EXCLUDE_END
    {
        AclMessagePanel() {
            ...
            for (i = 0; i < N_FIPA_PROTOCOLS; ++i)
                fipaProtocolArrayList.add(fipaProtocols[i]);
            ...
            receiverListPanel = new VisualAIDList(Collections.emptyIterator(), getChildrenOwner());
            ...
            replyToListPanel = new VisualAIDList(Collections.emptyIterator(), getChildrenOwner());
            ...
            for (String s : comm_Act)
                communicativeAct.addItem(s.toLowerCase());
            ...
            for (i = 0; i < fipaProtocolArrayList.size(); ++i)
                protocol.addItem(fipaProtocolArrayList.get(i));
            ...
            protocol.addActionListener(e -> {
                ...
                if (!protocol.isEditable()) {
                    ...
                    if (!fipaProtocolArrayList.contains(param) && !Objects.equals(param, "Null")) {
...
// END actionPerformed(ActionEvent e)
            replyBySet.addActionListener(e -> {
                        String command = e.getActionCommand();
            ...
            if (fileList != null) {
                ...
                while (fileItor.hasNext()) {
                    try {
                        ...
                        Enumeration<Object> receivers = receiverListPanel.getContent();
    ...
    private class EnvelopePanel extends JPanel {
        EnvelopePanel() {
            ...
            l = new JLabel("To:");
            put(aclPanel, l, 0, 0, 1, 1, false);
            toPanel = new VisualAIDList(Collections.emptyIterator(), getChildrenOwner());
            ...
            put(aclPanel, l, 0, 11, 1, 1, false);
            intendedReceiverPanel = new VisualAIDList(Collections.emptyIterator(), getChildrenOwner());
