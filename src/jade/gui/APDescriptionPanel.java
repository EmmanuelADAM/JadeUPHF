...
public class APDescriptionPanel extends JPanel {
    ...
    public APDescriptionPanel(Component owner) {
        ...
        platformName_Field.setBackground(Color.white);
        c.ipadx = 30;
        c.gridx = 1;
        c.gridy = 1;
        ...
        MTPs_List = new VisualAPServiceList(Collections.emptyIterator(), owner);
        c.gridx = 0;
        c.gridy = 4;
        c.gridwidth = 2;
    ...
    public static void showAPDescriptionInDialog(APDescription desc, Frame parent, String title) {
        ...
        okButton.addActionListener(e -> tempDlg.dispose());
