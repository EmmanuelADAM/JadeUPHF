...
public class AIDGui extends JDialog {
     ...
     * @param ed                  is true when the AID can be edited
        ...
        okButton.addActionListener(e -> {
            ...
            if (param.equals("OK")) {
                ...
                if (editable) {
                    ...
                    //addresses
                    Enumeration<Object> addresses = addressListPanel.getContent();

                    while (addresses.hasMoreElements())
                        out.addAddresses((String) addresses.nextElement());
                    //resolvers
                    Enumeration<Object> resolvers = resolverListPanel.getContent();
