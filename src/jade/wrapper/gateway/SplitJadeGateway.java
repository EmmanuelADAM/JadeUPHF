...
public class SplitJadeGateway extends DynamicJadeGateway {
    ...
    @Override
    public void checkJADE() throws ControllerException {
        ...
        MicroRuntime.startJADE(properties, () -> myLogger.log(Logger.INFO, "Disconnected from the platform at " + properties.getProperty(Profile.MAIN_HOST) + ":" + properties.getProperty(Profile.MAIN_PORT)));
