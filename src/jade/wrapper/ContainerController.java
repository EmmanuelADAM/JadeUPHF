...
public class ContainerController {
    ...
    public AgentController getAgent(String name, boolean isGuid) throws ControllerException {
        ...
        Agent instance = myImpl.acquireLocalAgent(agentID);
        if (instance == null) {
    ...
    public AgentController acceptNewAgent(String nickname, Agent anAgent) throws StaleProxyException {
        ...
        try {
            NodeDescriptor nd = myImpl.getNodeDescriptor();
     ...
     * @throws MTPException If something goes wrong during transport
     *                      protocol activation.
     */
     ...
     * @throws MTPException      If something goes wrong during transport
     *                           protocol activation.
     * @throws NotFoundException If no protocol with the given
