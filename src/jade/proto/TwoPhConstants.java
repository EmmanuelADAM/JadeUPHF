...
public interface TwoPhConstants {
    String JADE_TWO_PHASE_COMMIT = "Jade-Two-Phase-Commit";
    ...
    */
    int ALL_RESPONSES_RECEIVED = 1; // update1
    /* Possible TwoPh1Initiator's returned values */
    int ALL_CONFIRM = 1;
    int ALL_CONFIRM_OR_INFORM = 2;
    int SOME_DISCONFIRM = 3;
    int PH1_TIMEOUT_EXPIRED = MsgReceiver.TIMEOUT_EXPIRED;
