...
public class MessageTransportProtocol implements MTP {
    ...
    private TransportAddress activateServer(Dispatcher disp, TransportAddress ta, Profile p) throws MTPException {
        ...
        try {
            ...
            policy = p.getParameter(PREFIX + "policy", POLICY).equals("aggressive");
    ...
    public void deactivate(TransportAddress ta) throws MTPException {
        ...
        HTTPServer srv = addr2srv.get(ta.toString());
        if (srv != null) {
    ...
    public void deliver(String addr, Envelope env, byte[] payload) throws MTPException {
        ...
        try {
            ...
            byte[] boundaryBytes = boundary.toString().getBytes(StandardCharsets.ISO_8859_1);
