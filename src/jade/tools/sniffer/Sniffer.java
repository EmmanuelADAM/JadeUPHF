...
public class Sniffer extends ToolAgent {
    ...
    public void toolSetup() {
        ...
        if ((arguments != null) && (arguments.length > 0)) {
            ...
            for (Object argument : arguments) {
                s.append(argument.toString()).append(' ');
            }
            properties.setProperty("preload", s.toString());
  ...
  #DOTNET_INCLUDE_END*/
    ...
    protected void toolTakeDown() {
        ...
        List<Agent> l = (List<Agent>) (agentsUnderSniff.clone());
     ...
     **/
    public void sniffMsg(List<Agent> agents, boolean onFlag) {
     ...
     * updated.
     *
     * @param agents vector containing TreeData item representing the agents
     ...
     *               </ul>
     */
    public ACLMessage getSniffMsg(List<Agent> agents, boolean onFlag) {
    ...
    private class RequestListenerBehaviour extends SimpleAchieveREResponder {
        ...
        protected ACLMessage prepareResultNotification(ACLMessage request, ACLMessage response) {
            if (aa instanceof SniffOn requestSniffOn) {
                ...
                ArrayList<AID> agentsToSniff = requestSniffOn.getCloneOfSniffedAgents();
                for (AID o : agentsToSniff) {
                    if (allAgents.contains(o)) {
                        addAgent(o);
                    } else {
                        ...
                        preload.put(o.getName(), filter);
                    }
                }
            } else {
                // SNIFF OFF
                SniffOff requestSniffOff = (SniffOff) aa;
                ArrayList<AID> agentsToSniff = requestSniffOff.getCloneOfSniffedAgents();
                for (AID o : agentsToSniff) {
                    removeAgent(o);
                }
            }
