...
public class PopupMenuAgent extends JPopupMenu {
    ...
    public PopupMenuAgent(ActionProcessor actPro) {
        ...
        tmp = add(actPro.actions.get(ActionProcessor.DO_SNIFFER_ACTION));
        tmp.setIcon(null);

        tmp = add(actPro.actions.get(ActionProcessor.DO_NOT_SNIFFER_ACTION));
        tmp.setIcon(null);

        tmp = add(actPro.actions.get(ActionProcessor.SWOW_ONLY_ACTION));
        tmp.setIcon(null);
    }
