...
//    horizontal.setVisibleAmount(50);
    ...
    public void register(Object arg, String fieldName) {
        ...
        if (contentLanguage.contains("SL")) {
            //Only format when SL
            try {
                content = new SLFormatter().format(content);
            } catch (Exception ex) {
                //too bad!
            }
        }
...
//    msg.deleteObserver(this);
    ...
    public void focusLost(FocusEvent e) {
        ...
        try {
            Method sn = msg.getClass().getMethod(methodName, Class.forName(theType));
            sn.invoke(msg, value);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public static class TextUtilities {
         ...
         * @param offset The offset
         * @return Description of the Returned Value
         * @throws BadLocationException If an out-of-bounds access was
