...
public class JavaLoggingLogManagerImpl implements LogManager {
     ...
     */
    public List<LoggerInfo> getAllLogInfo() {
        ...
        if (this.loggers == null) {
            ...
            for (Enumeration<String> e = logManager.getLoggerNames(); e.hasMoreElements(); ) {
                ...
                try {
                    ...
                    List<String> loggerHandlers = (this.rootHandlers == null ? new ArrayList<>() : new ArrayList<>(this.rootHandlers));
    ...
    public void setLogLevel(String name, int level) {
        ...
        if (logger.getParent() != null) {
            ...
            for (Handler pHandler : pHandlers) {
                pHandler.setLevel(newLoggerLevel);
            }
        }
        Handler[] handlers = logger.getHandlers();
        for (Handler handler : handlers) {
            handler.setLevel(newLoggerLevel);
        }
    }
