...
public class LogManagerGUI extends JFrame {
    ...
    private final Map<String, ContainerLogWindow> managedContainers = new HashMap<>();
    ...
    public void resetTree() {
        Runnable r = agentTree::clearLocalPlatform;
        SwingUtilities.invokeLater(r);
    }

    public void addContainer(final String name, final InetAddress address) {
        Runnable r = () -> agentTree.addContainerNode(name, address);
        SwingUtilities.invokeLater(r);
    }

    public void removeContainer(final String name) {
        Runnable r = () -> agentTree.removeContainerNode(name);
        SwingUtilities.invokeLater(r);
    }

    public void refreshLocalPlatformName(final String name) {
        Runnable r = () -> agentTree.refreshLocalPlatformName(name);
        SwingUtilities.invokeLater(r);
    }
