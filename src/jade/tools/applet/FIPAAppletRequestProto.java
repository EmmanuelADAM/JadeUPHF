...
public class FIPAAppletRequestProto extends AppletRequestProto {
    ...
    public List<DFAgentDescription> getSearchResult() throws FIPAException, NotYetReady {
        if (notYetReady)
        ...
        try {
            if (this.action.equalsIgnoreCase(FIPAManagementVocabulary.REGISTER)) {    // refresh the gui
                ...
                try {
                    ...
                    gui.refreshLastSearchResults((ArrayList<DFAgentDescription>) getSearchResult(), msg.getSender());
                } catch (NotYetReady | FIPAException ignored) {
                }
