...
class InstallMTPDialog extends JDialog {
     ...
     */
    public InstallMTPDialog(Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        pack();
    }
    ...
    public void reset(String[] containers, String defaultContainer) {
        ...
        for (String container : containers) containerList.addElement(container);
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        containerList = new DefaultComboBoxModel<>(new String[]{"              "});

        containerChoice = new JComboBox<>(containerList);
        ...
        topPanel.setLayout(new GridLayout(3, 2, 10, 2));
        ...
        containerLabel.setBorder(new javax.swing.border.EmptyBorder(new Insets(2, 2, 2, 2)));
        containerLabel.setText("Container:");
        containerLabel.setFont(new Font("Dialog", Font.BOLD, 12));

        topPanel.add(containerLabel);

        containerChoice.setBorder(new javax.swing.border.EmptyBorder(new Insets(2, 2, 2, 2)));
        containerChoice.setFont(new Font("Dialog", Font.PLAIN, 12));

        topPanel.add(containerChoice);

        classLabel.setBorder(new javax.swing.border.EmptyBorder(new Insets(2, 2, 2, 2)));
        classLabel.setText("Class Name:");
        classLabel.setFont(new Font("Dialog", Font.BOLD, 12));
        ...
        addressLabel.setBorder(new javax.swing.border.EmptyBorder(new Insets(2, 2, 2, 2)));
        ...
        bottomPanel.setBorder(new javax.swing.border.EmptyBorder(new Insets(5, 5, 5, 5)));
...
// Add your handling code here:
        ...
        if (cls.length() == 0)
            JOptionPane.showMessageDialog(getParent(), "The class name for the MTP must be present", "Error during MTP installation.", JOptionPane.ERROR_MESSAGE);
        else
            destroy();
