...
public class BootGUI extends JDialog {
    ...
    Vector<PropertyType> propertiesVector;
    ...
    public BootGUI(Boot3 theBooter) {
        ...
        for (Enumeration<PropertyType> it = propertiesVector.elements();
             it.hasMoreElements(); ) {
            singlePanel propPanel = new singlePanel();
            PropertyType p = it.nextElement();
    ...
    ExtendedProperties extractPropertiesFromGui() {
        ...
        for (Enumeration<PropertyType> it = propertiesVector.elements();
             it.hasMoreElements(); ) {
            PropertyType prop = it.nextElement();
            ...
            for (int i = 0; (i < size) && !found; i++) {
                ...
                if (name.equalsIgnoreCase(label.getText())) {
                    ...
                    if (type.equalsIgnoreCase(PropertyType.COMBO_TYPE)) {
                        ...
                        //JComboBox
                        JComboBox<Component> box =
                                (JComboBox<Component>) singlePanel.getComponent(1);
     ...
     */
    ExtendedProperties readPropertiesFromFile(String fileName) throws IOException {
     ...
     */
    Vector<PropertyType> createPropertyVector(ExtendedProperties theProperties) {
        Vector<PropertyType> pv = new Vector<>();
    ...
    class singlePanel extends JPanel {
        ...
        JPanel newSinglePanel(PropertyType property) {
            ...
            if (type.equalsIgnoreCase(PropertyType.COMBO_TYPE)) {
                ...
                valueBox.setSelected(Boolean.parseBoolean(value));
