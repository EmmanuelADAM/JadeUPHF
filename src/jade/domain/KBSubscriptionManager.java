...
class KBSubscriptionManager implements SubscriptionResponder.SubscriptionManager {
    ...
    public boolean register(SubscriptionResponder.Subscription sub) throws RefuseException, NotUnderstoodException {
        ...
        DFAgentDescription dfdTemplate;
        ...
        // notification.
        List<DFAgentDescription> results = kBase.search(dfdTemplate, -1);
    ...
    private void notify(SubscriptionResponder.Subscription sub, List<DFAgentDescription> results, AbsIRE absIota) {
        try {
    ...
    private class SubscriptionInfo {
        private final SubscriptionResponder.Subscription subscription;
        private final DFAgentDescription template;
        private final AbsIRE absIota;
