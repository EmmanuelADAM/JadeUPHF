...
class AMSJadeAgentManagementBehaviour extends RequestManagementBehaviour {
    ...
    protected ACLMessage performAction(Action slAction, ACLMessage request) throws JADESecurityException, FIPAException {
        ...
        // INSTALL MTP
            ...
            MTPDescriptor dsc = null;
            try {
                dsc = theAMS.installMTPAction((InstallMTP) action, request.getSender());
            } catch (MTPException e) {
                throw new FIPAException("PB InstallMTP");
            }
        ...
        // UNINSTALL MTP
            ...
            try {
                ...
                throw new FIPAException("PB unInstallMTP");
            }
        }
        // SNIFF ON
