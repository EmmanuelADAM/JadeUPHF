            ...
            if (reply != null) {
                if (reply.getPerformative() == ACLMessage.INFORM) {
                    ...
                    switch (reply.getPerformative()) {
                        case ACLMessage.REFUSE -> throw new RefuseException(reply);
                        case ACLMessage.FAILURE -> throw new jade.domain.FIPAAgentManagement.FailureException(reply);
                        case ACLMessage.NOT_UNDERSTOOD -> throw new jade.domain.FIPAAgentManagement.NotUnderstoodException(reply);
                    }
                    //#MIDP_EXCLIDE_END
