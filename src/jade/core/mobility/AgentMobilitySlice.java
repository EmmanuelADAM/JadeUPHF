...
public interface AgentMobilitySlice extends Service.Slice {
    ...
    String H_FETCHCLASSFILE = "2";
    String H_MOVEAGENT = "3";
    String H_COPYAGENT = "4";
    String H_PREPARE = "5";
    String H_TRANSFERIDENTITY = "6";
    String H_HANDLETRANSFERRESULT = "7";
    String H_CLONEDAGENT = "8";
    //#J2ME_EXCLUDE_BEGIN
    String H_CLONECODELOCATORENTRY = "9";
    String H_REMOVECODELOCATORENTRY = "10";
    //#J2ME_EXCLUDE_END
    ...
    void handleTransferResult(AID agentID, boolean result, List<ACLMessage> messages) throws IMTPException, NotFoundException;
