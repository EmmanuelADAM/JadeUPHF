...
public class AgentReplicationService extends BaseService {
    ...
    @Override
    public Class<AgentReplicationSlice> getHorizontalInterface() {
        try {
            return (Class<AgentReplicationSlice>) Class.forName(NAME + "Slice");
    ...
    private class ServiceComponent implements Slice {
        ...
        public VerticalCommand serve(HorizontalCommand cmd) {
            try {
                ...
                switch (cmdName) {
                    case AgentReplicationSlice.H_INVOKEAGENTMETHOD -> {
