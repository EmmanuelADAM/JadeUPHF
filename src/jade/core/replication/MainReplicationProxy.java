...
public class MainReplicationProxy extends SliceProxy implements MainReplicationSlice {
    ...
    public void addReplica(String sliceName, String smAddr, int sliceIndex, NodeDescriptor dsc, Vector<ServiceDescriptor> services) throws IMTPException {
        try {
            GenericCommand cmd = new GenericCommand(H_ADDREPLICA, NAME, null);
            cmd.addParam(sliceName);
            cmd.addParam(smAddr);
            cmd.addParam(sliceIndex);
            cmd.addParam(dsc);
