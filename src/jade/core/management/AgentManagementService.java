    ...
    public void init(AgentContainer ac, Profile p) throws ProfileException {
        ...
        ObjectManager.addLoader(ObjectManager.AGENT_TYPE, new ObjectManager.Loader() {
            public Object load(String className, Properties pp) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
                ...
                } catch (IOException | NoSuchMethodException | InvocationTargetException ioe) {
    ...
    private class CommandSourceSink implements Sink {
        ...
        public void consume(VerticalCommand cmd) {
            ...
            try {
                switch (name) {
                    ...
                    case AgentManagementSlice.ADD_TOOL -> handleAddTool(cmd);
                    case AgentManagementSlice.REMOVE_TOOL -> handleRemoveTool(cmd);
                }
            } catch (Throwable t) {
        ...
        private void handleInformStateChanged(VerticalCommand cmd) {
            ...
            if (to.equals(jade.domain.FIPAAgentManagement.AMSAgentDescription.SUSPENDED)) {
                ...
                } catch (IMTPException | NotFoundException | ServiceException re) {
                    re.printStackTrace();
                }
            ...
            if (impl != null) {
                ...
                try {
                    ...
                    try {
                        ...
                        // else : The old agent is registered with the AMS, but does not live in the platform --> cannot check if it still exists
                        throw nce;
