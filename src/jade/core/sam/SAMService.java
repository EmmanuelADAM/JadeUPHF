...
public class SAMService extends BaseService {
    ...
    private void startPolling() throws ServiceException {
        ...
        try {
            ...
            Vector<Object> handlerClasses = new Vector<>();
            ...
            poller = new Poller(this, periodMinutes * 60000L, handlers);
            poller.startPolling();
        } catch (Exception e) {
    ...
    private class EntityInfo {
        ...
        private final List<AverageMeasureProvider> providers = new ArrayList<>();
    ...
    private class CounterInfo {
        private final String name;
        private final List<CounterValueProvider> providers = new ArrayList<>();
        private final List<Long> previousTotalValues = new ArrayList<>();
