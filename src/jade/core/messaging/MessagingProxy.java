...
public class MessagingProxy extends SliceProxy implements MessagingSlice {
    ...
    public void addRoute(MTPDescriptor mtp, String sliceName) throws IMTPException {
        try {
    ...
    public void removeRoute(MTPDescriptor mtp, String sliceName) throws IMTPException {
        try {
