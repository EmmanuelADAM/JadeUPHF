...
class LightResourceManager implements ResourceManager {
    ...
    public Thread getThread(int type, String name, Runnable r) {
        ...
        switch (type) {
            case USER_AGENTS -> t.setPriority(USER_AGENTS_PRIORITY);
            case SYSTEM_AGENTS -> t.setPriority(SYSTEM_AGENTS_PRIORITY);
            case TIME_CRITICAL -> t.setPriority(TIME_CRITICAL_PRIORITY);
        }
