...
public class Specifier {
     ...
     */
    public static Vector<Object> parseSpecifierList(String specsLine) throws Exception {
        Vector<Object> specs = parseList(specsLine, SPECIFIER_SEPARATOR);
    ...
    public static Vector<Object> parseList(String list, char delimiter) {
    ...
    private static String[] parseArguments(String args, char argsDelimiter) {
        ...
        // Last argument
        String arg = args.substring(argStart);
