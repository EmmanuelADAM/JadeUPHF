...
public class ThreadedBehaviourFactory {
    ...
    public void interrupt() {
        ...
        for (ThreadedBehaviourWrapper threadedBehaviourWrapper : tt) {
    ...
    public ThreadedBehaviourWrapper[] getWrappers() {
        synchronized (threadedBehaviours) {
            ...
            for (int i = 0; i < wrappers.length; ++i) {
                wrappers[i] = threadedBehaviours.elementAt(i);
            }
            return wrappers;
        }
    }
    ...
    public class ThreadedBehaviourWrapper extends Behaviour implements Runnable {
        ...
        public void run() {
            if (threadState.equals(CREATED_STATE)) {
                threadedBehaviours.addElement(this);
            } else if (threadState.equals(SUSPENDED_STATE)) {
            ...
            try {
                while (true) {
                    ...
                    synchronized (this) {
                        ...
                        if (myBehaviour.done()) {
                            ...
                            if (Thread.currentThread().isInterrupted() || threadState.equals(INTERRUPTED_STATE)) {
            ...
            } catch (InterruptedException | Agent.Interrupted ie) {
                ...
                if (threadState.equals(SUSPENDED_STATE)) {
        ...
        private void terminate() {
            if (Thread.currentThread() == myThread) {
                if (threadState.equals(INTERRUPTED_STATE) || threadState.equals(ERROR_STATE)) {
    ...
    private class DummyParentBehaviour extends CompositeBehaviour {
        private final ThreadedBehaviourWrapper myChild;
        ...
        public BehaviourList getChildren() {
            return null;
        }
