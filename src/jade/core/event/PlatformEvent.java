...
public class PlatformEvent extends JADEEvent implements jade.wrapper.PlatformEvent {
     ...
     * @param aid         The {@link AID AID} of the new or dead agent.
     * @param eventSource The container id of the source of the event.
     ...
     * <p>
     *
     * @param aid         The {@link AID AID} of the moved agent.
    ...
    public String toString() {
        ...
        switch (type) {
            case ADDED_CONTAINER -> buf.append("add container: ").append(getSource());
            case REMOVED_CONTAINER -> buf.append("remove container: ").append(getSource());
            case BORN_AGENT -> buf.append("born agent: ").append(agent)
                    .append(" in ").append(getSource());
            case DEAD_AGENT -> buf.append("dead agent: ").append(agent)
                    .append(" in ").append(getSource());
            case SUSPENDED_AGENT -> buf.append("suspended agent: ").append(agent)
                    .append(" in ").append(getSource());
            case RESUMED_AGENT -> buf.append("resumed agent: ").append(agent)
                    .append(" in ").append(getSource());
            case MOVED_AGENT -> buf.append("moved agent: ").append(agent)
                    .append(" from: ").append(getSource())
                    .append(" to: ").append(newContainer);

//			__SECURITY__BEGIN
            case CHANGED_AGENT_PRINCIPAL -> buf.append("changed agent ownership: ").append(agent)
                    .append(" in: ").append(getSource())
                    .append(" from: ").append(oldOwnership)
                    .append(" to: ").append(newOwnership);
            case CHANGED_CONTAINER_PRINCIPAL -> buf.append("changed container ownership: ").append(getSource())
                    .append(" from: ").append(oldOwnership)
                    .append(" to: ").append(newOwnership);
