...
public class TimerDispatcher implements Runnable {
    ...
    private class TimersList {
        private final TreeSet<Object> set = new TreeSet<>(new TimerComparator());
    ...
    private class TimerComparator implements Comparator<Object> {
        public int compare(Object o1, Object o2) {
            Timer t1 = (Timer) o1;
            Timer t2 = (Timer) o2;
            return Long.compare(t1.expirationTime(), t2.expirationTime());
        }
    }
    //#J2ME_EXCLUDE_END
}
