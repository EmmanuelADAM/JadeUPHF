...
class ServiceManagerRMIImpl extends UnicastRemoteObject implements ServiceManagerRMI {
    ...
    public String addNode(NodeDescriptor dsc, Vector<ServiceDescriptor> nodeServices, boolean propagated) throws RemoteException, ServiceException, JADESecurityException {
        try {
    ...
    public Vector<Service.Slice> findAllSlices(String serviceKey) throws RemoteException, ServiceException {
        try {
