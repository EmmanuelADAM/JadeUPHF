...
public interface ServiceManagerRMI extends Remote {
    ...
    String addNode(NodeDescriptor dsc, Vector<ServiceDescriptor> nodeServices, boolean propagated) throws RemoteException, ServiceException, JADESecurityException;
    ...
    Vector<Service.Slice> findAllSlices(String serviceKey) throws RemoteException, ServiceException;
