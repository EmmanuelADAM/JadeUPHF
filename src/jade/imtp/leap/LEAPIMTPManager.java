    ...
    public void initialize(Profile p) throws IMTPException {
        ...
        try {
            ...
            for (Specifier o : l) {
                ...
                try {
                    ICP peer = (ICP) Class.forName(o.getClassName()).getDeclaredConstructor().newInstance();
                    String id = (o.getArgs() != null ? (String) (o.getArgs()[0]) : null);
    ...
    private void setDefaults() throws ProfileException {
        ...
        if (mainURL == null) {
            ...
            if (mainHost != null) {
                ...
                mainURL = mainProto + "://" + mainHost + mainPort;
