...
public class HTTPProtocol extends TransportProtocol {
    ...
    public String addrToString(TransportAddress ta) throws ICPException {
        ...
        try {
            ...
            throw new ICPException("The TransportAddress " + ta + " is not an HTTP Address");
        }
    ...
    public TransportAddress stringToAddr(String s) throws ICPException {
        ...
        String protocol = addressFields.elementAt(0);

        if (!NAME.equals(protocol)) {
            throw new ICPException("Unexpected protocol \"" + protocol + "\" when \"" + NAME + "\" was expected.");
        }

        String host = addressFields.elementAt(1);
        String port = addressFields.elementAt(2);
        String file = addressFields.elementAt(3);
        String anchor = addressFields.elementAt(4);
