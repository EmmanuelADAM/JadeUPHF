...
public class HTTPPacket {
    ...
    protected Hashtable<CaseInsensitiveString, String> fields = new Hashtable<>();
    ...
    public String getField(String key) {
        return fields.get(new CaseInsensitiveString(key));
    }
    ...
    protected void readFrom(InputStream is) throws IOException {
        ...
        try {
            int length = Integer.parseInt(fields.get(CONTENT_LENGTH_KEY));
    ...
    protected void writeTo(OutputStream os) throws IOException {
        ...
        Enumeration<CaseInsensitiveString> e = fields.keys();
        while (e.hasMoreElements()) {
            CaseInsensitiveString key = e.nextElement();
    ...
    public String toString() {
        ...
        if (payload != null) {
            sb.append("-------------\nPayload size: ").append(payload.length).append("\n");
        }
        return sb.toString();
    }
}
