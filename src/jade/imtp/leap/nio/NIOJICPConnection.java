...
public class NIOJICPConnection extends Connection {
     ...
     * @throws IOException
     */
    private int readFromChannel(ByteBuffer b) throws IOException {
     ...
     * When the buffer returned by , no write will be performed.
     *
    ...
    private class BufferTransformerInfo {
        private final BufferTransformer transformer;
