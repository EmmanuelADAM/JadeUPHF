...
public final class SSLEngineHelper implements BufferTransformer {
    ...
    private int writeToChannel(ByteBuffer b) throws IOException {
        int m = b.remaining();
    ...
    private void checkStatusAfterHandshakeTasks(HandshakeStatus handshakeStatus) throws IOException {
     ...
     * @throws IOException
     */
    private synchronized int decrypt(ByteBuffer socketData) throws IOException {
        if (log.isLoggable(Level.FINE)) {
    ...
    public synchronized ByteBuffer postprocessBufferRead(ByteBuffer socketData) throws IOException {
