        ...
        public void run() {
            ...
            try {
                            ...
                            if (acceptMediators) {
                                ...
                                if (id != null) {
                                    ...
                                    if (id == null) {
                                        ...
                                        id = "BE-" + getLocalHost() + ':' + getLocalPort() + '-' + mediatorCnt++;
                                    }
                                }
                ...
                switch (status) {
                    ...
                    case REQUEST_SERVED:
                        if (myLogger.isLoggable(Logger.SEVERE))
                            myLogger.log(Logger.SEVERE, "Communication error writing return packet to " + addr + ":" + port + " [" + e + "]");
                        break;
                    case RESPONSE_SENT:
                        ...
                        if (e instanceof EOFException) {
                            ...
                            if (myLogger.isLoggable(Logger.FINE))
                                myLogger.log(Logger.FINE, "Unexpected client " + addr + ":" + port + " termination. " + e);
                        }
                }
            } finally {
                try {
