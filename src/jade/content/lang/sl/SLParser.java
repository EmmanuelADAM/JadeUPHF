...
class SLParser implements SLParserConstants {
    ...
    final public AbsTerm Term() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case INTEGER, HEXINTEGER, FLOATONE, FLOATTWO, WORD, STRING_LITERAL, DATETIME, PREFIXBYTELENGTHENCODEDSTRING, WORD2, STRING_LITERAL2 -> val = Constant();
            case LBRACE, LBRACE2 -> {
                LBrace();
                switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
    ...
    final public AbsPrimitive Constant() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case INTEGER, HEXINTEGER, FLOATONE, FLOATTWO -> val = Number();
            case DATETIME -> {
    ...
    final public AbsConcept FunctionalTerm_NoBrace() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case WORD, STRING_LITERAL, WORD2, STRING_LITERAL2 -> {
                ...
                switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                    case LBRACE, VARIABLE, INTEGER, HEXINTEGER, FLOATONE, FLOATTWO, WORD, STRING_LITERAL, PARAMETERNAME, PARAMETERNAME_STRING, DATETIME, PREFIXBYTELENGTHENCODEDSTRING, METASYMBOL, LBRACE2, WORD2, STRING_LITERAL2, METASYMBOL2 -> FunctionalTermParameters(val);
