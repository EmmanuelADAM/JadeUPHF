...
class ExtendedSLParser implements ExtendedSLParserConstants {
    ...
    final public void LBrace() throws ParseException {
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case LBRACE2 -> jj_consume_token(LBRACE2);
            default -> {
                jj_la1[1] = jj_gen;
                jj_consume_token(-1);
    ...
    final public void RBrace() throws ParseException {
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case RBRACE -> jj_consume_token(RBRACE);
            case RBRACE2 -> jj_consume_token(RBRACE2);
            default -> {
                jj_la1[2] = jj_gen;
                jj_consume_token(-1);
                throw new ParseException();
    ...
    final public AbsContentElement ContentExpression() throws ParseException {
        ...
        String s;
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case WORD, STRING_LITERAL, WORD2, STRING_LITERAL2 -> {
                s = String();
    ...
    final public AbsContentElement ContentExpression_NoBrace() throws ParseException {
        AbsContentElement val;
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case REFERENTIALOP -> val = IdentifyingExpression_NoBrace();
            case ACTION, ACTIONOPLL -> val = ActionExpression_NoBrace();
            case WORD, STRING_LITERAL, MODALOP, ACTIONOP, UNARYLOGICALOP, BINARYLOGICALOP, QUANTIFIER, WORD2, STRING_LITERAL2 -> val = Wff_NoBrace();
            default -> {
                jj_la1[4] = jj_gen;
                jj_consume_token(-1);
                throw new ParseException();
    ...
    final public AbsIRE IdentifyingExpression_NoBrace() throws ParseException {
        ...
        if (slType < 2) {
            if (true) throw new ParseException("NotFullSL_IdentifyExpression_NotParsable_UseAtLeastSL2");
        }
        term = Term();
        /*var=Variable()*/
        prop = Wff();
    ...
    final public AbsTerm Term() throws ParseException {
        ...
        String s;
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case VARIABLE -> val = Variable();
            case INTEGER, HEXINTEGER, LONG, FLOATONE, FLOATTWO, FLOAT, WORD, STRING_LITERAL, DATETIME, PREFIXBYTELENGTHENCODEDSTRING, WORD2, STRING_LITERAL2 -> val = Constant();
            case LBRACE, LBRACE2 -> {
                LBrace();
                switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                    case WORD, STRING_LITERAL, ARITHMETICOP, WORD2, STRING_LITERAL2 -> val = FunctionalTerm_NoBrace();
                    case ACTION, ACTIONOPLL -> val = ActionExpression_NoBrace();
                    case REFERENTIALOP -> val = IdentifyingExpression_NoBrace();
                    default -> {
                        jj_la1[5] = jj_gen;
    ...
    final public AbsPrimitive Constant() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case INTEGER, HEXINTEGER, LONG, FLOATONE, FLOATTWO, FLOAT -> val = Number();
            case DATETIME -> {
            ...
            case PREFIXBYTELENGTHENCODEDSTRING -> {
                ...
                byte[] byteArray = Base64.decodeBase64(t.image.getBytes(StandardCharsets.US_ASCII));
    ...
    final public AbsConcept FunctionalTerm_NoBrace() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case WORD, STRING_LITERAL, WORD2, STRING_LITERAL2 -> {
                ...
                switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                    case LBRACE, VARIABLE, INTEGER, HEXINTEGER, LONG, FLOATONE, FLOATTWO, FLOAT, WORD, STRING_LITERAL, PARAMETERNAME, PARAMETERNAME_STRING, DATETIME, PREFIXBYTELENGTHENCODEDSTRING, METASYMBOL, LBRACE2, WORD2, STRING_LITERAL2, METASYMBOL2 -> FunctionalTermParameters(val);
...
// val can be either an AbsConcept or an AbsAggregate
    ...
    final public AbsAgentAction ActionExpression_NoBrace() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case ACTIONOPLL -> {
                ...
                if (slType < 2) {
                    if (true) throw new ParseException("NotFullSL_ActionOperatorExpression_NotParsable");
                }
    ...
    final public AbsPredicate Wff_NoBrace() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case UNARYLOGICALOP -> {
                ...
                if (slType < 1) {
                    if (true) throw new ParseException("NotFullSL_NotExpression_NotParsable_UseAtLeastSL1");
                }
                arg1 = Wff();
            ...
            case BINARYLOGICALOP -> {
                ...
                if (slType < 1) {
                    if (true) throw new ParseException("NotFullSL_BinaryLogicalExpression_NotParsable_UseAtLeastSL1");
                }
                arg1 = Wff();
                arg2 = Wff();
                val = new AbsPredicate(t.image);
            ...
            case QUANTIFIER -> {
                ...
                if (slType < 2) {
                    if (true) throw new ParseException("NotFullSL_QuantifierExpression_NotParsable_UseAtLeastSL2");
                }
                AbsVariable var;
                var = Variable();
                arg1 = Wff();
            ...
            case MODALOP -> {
                ...
                if (slType < 2) {
                    if (true) throw new ParseException("NotFullSL_ModalOperatorExpression_NotParsable_UseAtLeastSL2");
                }
                term = Term();
                arg1 = Wff();
                val = new AbsPredicate(t.image);
            ...
            case ACTIONOP -> {
                ...
                switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                    case LBRACE, WORD, STRING_LITERAL, METASYMBOL, LBRACE2, WORD2, STRING_LITERAL2, METASYMBOL2 -> {
                        arg1 = Wff();
                        try {
                            val.set(slotNames[1], arg1);
                        } catch (Exception e) {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case FLOAT -> {
                ...
                try {
                    ...
                    val = AbsPrimitive.wrap(Float.parseFloat(floatStr));
                } catch (NumberFormatException e) { //should never happen
                    e.printStackTrace();
                    val = AbsPrimitive.wrap(t.image);
                }
    ...
    final public String MetaSymbol() throws ParseException {
        Token t;
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case METASYMBOL -> t = jj_consume_token(METASYMBOL);
            case METASYMBOL2 -> t = jj_consume_token(METASYMBOL2);
            default -> {
                jj_la1[22] = jj_gen;
                jj_consume_token(-1);
                throw new ParseException();
        ...
        if (!metaAllowed) {
            if (true) throw new ParseException(META_EXCEPTION_MESSAGE);
        } else {
            if (true) return t.image;
        }
        throw new Error("Missing return statement in function");
