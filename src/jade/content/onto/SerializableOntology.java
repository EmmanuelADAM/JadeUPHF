    ...
    protected Object toObject(AbsObject abs, String lcType, Ontology globalOnto) throws OntologyException {
        if (SERIALIZABLE.equals(abs.getTypeName())) {
            try {
                ...
                byte[] value = Base64.decodeBase64(stringValue.getBytes(StandardCharsets.US_ASCII));
                //#J2ME_EXCLUDE_BEGIN
    ...
    protected AbsObject fromObject(Object obj, Ontology globalOnto) throws OntologyException {
        ...
        if (obj instanceof Serializable) {
            try {
                ...
                String stringValue = new String(Base64.encodeBase64(baos.toByteArray()), StandardCharsets.US_ASCII);
