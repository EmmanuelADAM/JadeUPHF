...
public class BasicOntology extends Ontology implements SL0Vocabulary {
    ...
    private void initialize() {
        ...
        try {
            ...
            doneSchema.add(DONE_CONDITION, PredicateSchema.getBaseSchema(), ObjectSchema.OPTIONAL);

            // RESULT Schema
            PredicateSchema resultSchema = (PredicateSchema) getSchema(RESULT);
            resultSchema.add(RESULT_ACTION, AgentActionSchema.getBaseSchema());
            resultSchema.add(RESULT_VALUE, TermSchema.getBaseSchema());
    ...
    protected AbsObject fromObject(Object obj, Ontology referenceOnto) throws OntologyException {
        try {
            ...
            if (obj instanceof Float) {
                return AbsPrimitive.wrap((Float) obj);
            }
            ...
            if (obj instanceof List) {
                return AbsHelper.externaliseList((List<Object>) obj, referenceOnto, SEQUENCE);
            }

            if (obj instanceof Set) {
                return AbsHelper.externaliseSet((Set<Object>) obj, referenceOnto, SET);
            }

            if (obj instanceof Iterator) {
                return AbsHelper.externaliseIterator((Iterator<Object>) obj, referenceOnto, SEQUENCE);
            }
            ...
            if (obj instanceof Done) {
                ...
                absDone.set(BasicOntology.DONE_ACTION, referenceOnto.fromObject(((Done) obj).getAction()));
                if (((Done) obj).getCondition() != null) {
                    absDone.set(BasicOntology.DONE_CONDITION, referenceOnto.fromObject(((Done) obj).getCondition()));
                }
                return absDone;
            }
            ...
            if (obj instanceof Result) {
                ...
                absResult.set(BasicOntology.RESULT_ACTION, referenceOnto.fromObject(((Result) obj).getAction()));
                absResult.set(BasicOntology.RESULT_VALUE, referenceOnto.fromObject(((Result) obj).getValue()));
                return absResult;
            }

            if (obj instanceof Equals) {
                AbsPredicate absEquals = new AbsPredicate(BasicOntology.EQUALS);
                absEquals.set(BasicOntology.EQUALS_LEFT, referenceOnto.fromObject(((Equals) obj).getLeft()));
                absEquals.set(BasicOntology.EQUALS_RIGHT, referenceOnto.fromObject(((Equals) obj).getRight()));
                return absEquals;
            }
    ...
    public ObjectSchema getSchema(Class<?> clazz) throws OntologyException {
        //#MIDP_EXCLUDE_BEGIN
        ObjectSchema schema = primitiveSchemas.get(clazz);
        if (schema == null) {
